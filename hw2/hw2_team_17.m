...
%
% To run on simulator: If you run it on the simulator, it will 
% automatically use values for the simulator. 
%
% To run in MATLAB: hw2_team_17(r, TRUE); 
% Using the TRUE boolean ensure that it will run with values for the robot
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function hw2_team_17(serPort, is_robot) 
    ...
    % Rotates robot the mod of the current angle
    % We include a rotation compensation because our robot does not turn
    % the right amount
